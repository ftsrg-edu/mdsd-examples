...
import hu.bme.mit.mdsd.m2m2c.queries.Attribute_UDMatcher
...
class AttributeRule_UD extends AbstractRule{
	...
	new(ViatraQueryEngine engine, IModelManipulations manipulation, TraceRoot traceRoot) {
		...
		rule = createRule.name("AttributeRule")
			...
			.precondition(Attribute_UDMatcher.querySpecification)
