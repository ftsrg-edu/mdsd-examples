/**
 */
package hu.bme.mit.mdsd.rdb.util;
 ...
 * @generated
 */
public class RdbSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RdbPackage.KEY: {
				...
				if (result == null) result = caseColumn(key);
				if (result == null) result = caseNamedElement(key);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RdbPackage.FOREIGN_KEY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Relational Data Base</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Relational Data Base</em>'.
