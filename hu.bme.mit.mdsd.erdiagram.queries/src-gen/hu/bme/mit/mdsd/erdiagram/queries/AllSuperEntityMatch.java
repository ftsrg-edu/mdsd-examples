...
/**
 * Pattern-specific match representation of the hu.bme.mit.mdsd.erdiagram.queries.allSuperEntity pattern,
 * to be used in conjunction with {@link AllSuperEntityMatcher}.
 * 
...
public abstract class AllSuperEntityMatch extends BasePatternMatch {
  private Entity fE;
  ...
  private AllSuperEntityMatch(final Entity pE, final Entity pSuperEntity) {
    this.fE = pE;
  ...
  public boolean set(final String parameterName, final Object newValue) {
    ...
    if ("superEntity".equals(parameterName) ) {
    	this.fSuperEntity = (Entity) newValue;
    	return true;
    }
    return false;
  }
  ...
  public List<String> parameterNames() {
    return AllSuperEntityMatch.parameterNames;
  }
  ...
  @Override
  public AllSuperEntityMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof AllSuperEntityMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    AllSuperEntityMatch other = (AllSuperEntityMatch) obj;
  ...
  @Override
  public AllSuperEntityQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static AllSuperEntityMatch newEmptyMatch() {
   ...
   * 
   */
  public static AllSuperEntityMatch newMutableMatch(final Entity pE, final Entity pSuperEntity) {
   ...
   * 
   */
  public static AllSuperEntityMatch newMatch(final Entity pE, final Entity pSuperEntity) {
    return new Immutable(pE, pSuperEntity);
  }
  
  private static final class Mutable extends AllSuperEntityMatch {
  ...
  private static final class Immutable extends AllSuperEntityMatch {
