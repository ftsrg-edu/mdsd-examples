...
public class EntityStartsWithSmallCaseMatcher extends BaseMatcher<EntityStartsWithSmallCaseMatch> {
   ...
   * 
   */
  public static EntityStartsWithSmallCaseMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    EntityStartsWithSmallCaseMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new EntityStartsWithSmallCaseMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(EntityStartsWithSmallCaseMatcher.class);
   ...
   */
  @Deprecated
  public EntityStartsWithSmallCaseMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public EntityStartsWithSmallCaseMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected EntityStartsWithSmallCaseMatch tupleToMatch(final Tuple t) {
    try {
    	return EntityStartsWithSmallCaseMatch.newMatch((hu.bme.mit.mdsd.erdiagram.Entity) t.get(POSITION_ENTITY));
  ...
  protected EntityStartsWithSmallCaseMatch arrayToMatch(final Object[] match) {
    try {
    	return EntityStartsWithSmallCaseMatch.newMatch((hu.bme.mit.mdsd.erdiagram.Entity) match[POSITION_ENTITY]);
    } catch(ClassCastException e) {
  ...
  protected EntityStartsWithSmallCaseMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return EntityStartsWithSmallCaseMatch.newMutableMatch((hu.bme.mit.mdsd.erdiagram.Entity) match[POSITION_ENTITY]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<EntityStartsWithSmallCaseMatcher> querySpecification() throws IncQueryException {
