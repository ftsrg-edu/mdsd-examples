...
public class FirtEntityMatcher extends BaseMatcher<FirtEntityMatch> {
   ...
   * 
   */
  public static FirtEntityMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    FirtEntityMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new FirtEntityMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(FirtEntityMatcher.class);
   ...
   */
  @Deprecated
  public FirtEntityMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public FirtEntityMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected FirtEntityMatch tupleToMatch(final Tuple t) {
    try {
    	return FirtEntityMatch.newMatch((hu.bme.mit.mdsd.erdiagram.Entity) t.get(POSITION_E));
  ...
  protected FirtEntityMatch arrayToMatch(final Object[] match) {
    try {
    	return FirtEntityMatch.newMatch((hu.bme.mit.mdsd.erdiagram.Entity) match[POSITION_E]);
    } catch(ClassCastException e) {
  ...
  protected FirtEntityMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return FirtEntityMatch.newMutableMatch((hu.bme.mit.mdsd.erdiagram.Entity) match[POSITION_E]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<FirtEntityMatcher> querySpecification() throws IncQueryException {
