...
public class CircleInTypeHierarchyMatcher extends BaseMatcher<CircleInTypeHierarchyMatch> {
   ...
   * 
   */
  public static CircleInTypeHierarchyMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    CircleInTypeHierarchyMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (CircleInTypeHierarchyMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static CircleInTypeHierarchyMatcher create() throws ViatraQueryException {
    return new CircleInTypeHierarchyMatcher();
  }
  
  private final static int POSITION_ENTITY = 0;
  
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CircleInTypeHierarchyMatcher.class);
   ...
   * 
   */
  private CircleInTypeHierarchyMatcher() throws ViatraQueryException {
  ...
  protected CircleInTypeHierarchyMatch tupleToMatch(final Tuple t) {
    try {
    	return CircleInTypeHierarchyMatch.newMatch((Entity) t.get(POSITION_ENTITY));
  ...
  protected CircleInTypeHierarchyMatch arrayToMatch(final Object[] match) {
    try {
    	return CircleInTypeHierarchyMatch.newMatch((Entity) match[POSITION_ENTITY]);
    } catch(ClassCastException e) {
  ...
  protected CircleInTypeHierarchyMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return CircleInTypeHierarchyMatch.newMutableMatch((Entity) match[POSITION_ENTITY]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<CircleInTypeHierarchyMatcher> querySpecification() throws ViatraQueryException {
