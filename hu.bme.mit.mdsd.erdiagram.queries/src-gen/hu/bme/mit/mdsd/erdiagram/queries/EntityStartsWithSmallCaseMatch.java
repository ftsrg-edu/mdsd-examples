...
/**
 * Pattern-specific match representation of the hu.bme.mit.mdsd.erdiagram.queries.entityStartsWithSmallCase pattern,
 * to be used in conjunction with {@link EntityStartsWithSmallCaseMatcher}.
 * 
...
public abstract class EntityStartsWithSmallCaseMatch extends BasePatternMatch {
  private Entity fEntity;
  
  private static List<String> parameterNames = makeImmutableList("entity");
  
  private EntityStartsWithSmallCaseMatch(final Entity pEntity) {
  ...
  public List<String> parameterNames() {
    return EntityStartsWithSmallCaseMatch.parameterNames;
  }
  ...
  @Override
  public EntityStartsWithSmallCaseMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof EntityStartsWithSmallCaseMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    EntityStartsWithSmallCaseMatch other = (EntityStartsWithSmallCaseMatch) obj;
  ...
  @Override
  public EntityStartsWithSmallCaseQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static EntityStartsWithSmallCaseMatch newEmptyMatch() {
   ...
   * 
   */
  public static EntityStartsWithSmallCaseMatch newMutableMatch(final Entity pEntity) {
   ...
   * 
   */
  public static EntityStartsWithSmallCaseMatch newMatch(final Entity pEntity) {
    return new Immutable(pEntity);
  }
  
  private static final class Mutable extends EntityStartsWithSmallCaseMatch {
  ...
  private static final class Immutable extends EntityStartsWithSmallCaseMatch {
