...
public final class RelationWithRightEndingQuerySpecification extends BaseGeneratedEMFQuerySpecification<RelationWithRightEndingMatcher> {
   ...
   * 
   */
  public static RelationWithRightEndingQuerySpecification instance() throws IncQueryException {
    try{
  ...
  @Override
  protected RelationWithRightEndingMatcher instantiate(final IncQueryEngine engine) throws IncQueryException {
  ...
  private static class LazyHolder {
    private final static RelationWithRightEndingQuerySpecification INSTANCE = make();
    
    public static RelationWithRightEndingQuerySpecification make() {
      return new RelationWithRightEndingQuerySpecification();					
    }
  }
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public List<PParameter> getParameters() {
      return Arrays.asList(new PParameter("r", "hu.bme.mit.mdsd.erdiagram.Relation"),new PParameter("rre", "hu.bme.mit.mdsd.erdiagram.RelationEnding"));
    }
      ...
      try {
      	{
      		...
      		body.setSymbolicParameters(Arrays.<ExportedParameter>asList(
      		   ...
      		   new ExportedParameter(body, var_rre, "rre")
      		));
