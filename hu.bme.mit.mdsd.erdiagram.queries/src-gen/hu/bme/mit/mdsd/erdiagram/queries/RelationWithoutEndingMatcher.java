...
public class RelationWithoutEndingMatcher extends BaseMatcher<RelationWithoutEndingMatch> {
   ...
   * 
   */
  public static RelationWithoutEndingMatcher on(final IncQueryEngine engine) throws IncQueryException {
    // check if matcher already exists
    RelationWithoutEndingMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = new RelationWithoutEndingMatcher(engine);
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(RelationWithoutEndingMatcher.class);
   ...
   */
  @Deprecated
  public RelationWithoutEndingMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public RelationWithoutEndingMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  protected RelationWithoutEndingMatch tupleToMatch(final Tuple t) {
    try {
    	return RelationWithoutEndingMatch.newMatch((hu.bme.mit.mdsd.erdiagram.Relation) t.get(POSITION_R));
  ...
  protected RelationWithoutEndingMatch arrayToMatch(final Object[] match) {
    try {
    	return RelationWithoutEndingMatch.newMatch((hu.bme.mit.mdsd.erdiagram.Relation) match[POSITION_R]);
    } catch(ClassCastException e) {
  ...
  protected RelationWithoutEndingMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return RelationWithoutEndingMatch.newMutableMatch((hu.bme.mit.mdsd.erdiagram.Relation) match[POSITION_R]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<RelationWithoutEndingMatcher> querySpecification() throws IncQueryException {
