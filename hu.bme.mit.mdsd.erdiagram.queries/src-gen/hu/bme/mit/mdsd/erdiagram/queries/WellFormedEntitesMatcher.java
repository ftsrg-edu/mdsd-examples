...
public class WellFormedEntitesMatcher extends BaseMatcher<WellFormedEntitesMatch> {
   ...
   * 
   */
  public static WellFormedEntitesMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
    // check if matcher already exists
    WellFormedEntitesMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
    	matcher = (WellFormedEntitesMatcher)engine.getMatcher(querySpecification());
    }
    return matcher;
  }
   ...
   * 
   */
  public static WellFormedEntitesMatcher create() throws ViatraQueryException {
    return new WellFormedEntitesMatcher();
  }
  
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(WellFormedEntitesMatcher.class);
   ...
   * 
   */
  private WellFormedEntitesMatcher() throws ViatraQueryException {
   ...
   * 
   */
  public static IQuerySpecification<WellFormedEntitesMatcher> querySpecification() throws ViatraQueryException {
