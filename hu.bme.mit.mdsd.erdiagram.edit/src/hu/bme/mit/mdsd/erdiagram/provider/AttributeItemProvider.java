...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.mdsd.erdiagram.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_isKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_isKey_feature", "_UI_Attribute_type"),
				 ErdiagramPackage.Literals.ATTRIBUTE__IS_KEY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ErdiagramPackage.Literals.ATTRIBUTE__TYPE,
				 true,
				 false,
				 false,
