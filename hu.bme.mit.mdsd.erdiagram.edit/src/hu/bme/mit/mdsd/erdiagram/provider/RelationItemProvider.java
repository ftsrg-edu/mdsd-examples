...
/**
 * This is the item provider adapter for a {@link hu.bme.mit.mdsd.erdiagram.Relation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RelationItemProvider extends NamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ErdiagramPackage.Literals.RELATION__LEFT_ENDING);
			childrenFeatures.add(ErdiagramPackage.Literals.RELATION__RIGHT_ENDING);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ErdiagramPackage.Literals.RELATION__LEFT_ENDING,
				 ErdiagramFactory.eINSTANCE.createRelationEnding()));

		newChildDescriptors.add
			(createChildParameter
				(ErdiagramPackage.Literals.RELATION__RIGHT_ENDING,
				 ErdiagramFactory.eINSTANCE.createRelationEnding()));
	}
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == ErdiagramPackage.Literals.RELATION__LEFT_ENDING ||
			childFeature == ErdiagramPackage.Literals.RELATION__RIGHT_ENDING;
