...
public class ERDiagramDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cIsAEntityCrossReference_3_1_0 = (CrossReference)cIsAAssignment_3_1.eContents().get(0);
		private final RuleCall cIsAEntityIDTerminalRuleCall_3_1_0_1 = (RuleCall)cIsAEntityCrossReference_3_1_0.eContents().get(1);
		...
		//Entity:
		//	'entity' name=ID ('key' key=[Attribute])? ('isA' isA+=[Entity])* ('{'
		//	attributes+=Attribute (',' attributes+=Attribute)*
		//	'}')?;
		@Override public ParserRule getRule() { return rule; }
		
		//'entity' name=ID ('key' key=[Attribute])? ('isA' isA+=[Entity])* ('{' attributes+=Attribute (',' attributes+=Attribute)*
		//'}')?
		public Group getGroup() { return cGroup; }
		...
		//[Entity]
		public CrossReference getIsAEntityCrossReference_3_1_0() { return cIsAEntityCrossReference_3_1_0; }
		
		//ID
		public RuleCall getIsAEntityIDTerminalRuleCall_3_1_0_1() { return cIsAEntityIDTerminalRuleCall_3_1_0_1; }
